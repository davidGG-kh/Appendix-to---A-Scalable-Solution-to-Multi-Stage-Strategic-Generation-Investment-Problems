...
*        Check convergence
         ...
         Converge=1$(sum((t,gamma,k,c), Conv(PH_iter,t,gasmma,k,c))=card(t)*card(gamma)*card(k)*card(c));
);
);
...
****************Export results
File results_PH_LT_MS_rho_10_6 /results_PH_LT_MS_rho_10_6.csv/;
results_PH_LT_MS_rho_10_6.pc=5;
Put results_PH_LT_MS_rho_10_6;
